...
CONST_DATA struct ItemData gItemData[] = {
	...
	[ITEM_ANIMA_EXCALIBUR] = {
		...
		.weaponType = ITYPE_ANIMA,
		.attributes = IA_WEAPON | IA_MAGIC | IA_UNBREAKABLE | IA_UNSELLABLE,
	...
	[ITEM_SWORD_SIEGLINDE] = {
		...
		.weaponType = ITYPE_SWORD,
		.attributes = IA_WEAPON | IA_UNBREAKABLE | IA_UNSELLABLE | IA_LOCK_4,
	...
	[ITEM_STAFF_LATONA] = {
		...
		.weaponType = ITYPE_STAFF,
		.attributes = IA_STAFF | IA_UNBREAKABLE | IA_UNSELLABLE,
		.hit = 100,
		.weight = 5,
		.encodedRange = 0xFF,
		.weaponRank = WPN_EXP_S,
	...
	[ITEM_LANCE_VIDOFNIR] = {
		...
		.weaponType = ITYPE_LANCE,
		.attributes = IA_WEAPON | IA_UNBREAKABLE | IA_UNSELLABLE,
	...
	[ITEM_LANCE_SIEGMUND] = {
		...
		.weaponType = ITYPE_LANCE,
		.attributes = IA_WEAPON | IA_UNBREAKABLE | IA_UNSELLABLE | IA_LOCK_5,
	...
	[ITEM_DIVINESTONE] = {
		...
		.weaponType = ITYPE_11,
		.attributes = IA_WEAPON | IA_UNBREAKABLE | IA_UNSELLABLE | IA_LOCK_3,
